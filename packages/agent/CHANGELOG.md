...
- [#120](https://github.com/ziroagent/sdk-typescript/pull/120) [`99d2485`](https://github.com/ziroagent/sdk-typescript/commit/99d2485a9ff7f50b99ca396230a81a22b2523b42) Thanks [@vokhoadev](https://github.com/vokhoadev)! - Export `isContinueUpstreamMidToolCallError`, `MID_TOOL_CALL_CONTINUE_UPSTREAM_HINT`, `streamTailNeedsAgentRecovery`, and re-export `ContinueUpstreamMidToolCallError` / `tailBlocksContinueUpstream` for RFC 0018 recovery ergonomics.
...
- Updated dependencies [[`99d2485`](https://github.com/ziroagent/sdk-typescript/commit/99d2485a9ff7f50b99ca396230a81a22b2523b42), [`99d2485`](https://github.com/ziroagent/sdk-typescript/commit/99d2485a9ff7f50b99ca396230a81a22b2523b42), [`99d2485`](https://github.com/ziroagent/sdk-typescript/commit/99d2485a9ff7f50b99ca396230a81a22b2523b42), [`99d2485`](https://github.com/ziroagent/sdk-typescript/commit/99d2485a9ff7f50b99ca396230a81a22b2523b42)]:
  ...
  - @ziro-agent/tracing@0.12.0
  - @ziro-agent/memory@0.5.7
...
- [#115](https://github.com/ziroagent/sdk-typescript/pull/115) [`c5dc6d8`](https://github.com/ziroagent/sdk-typescript/commit/c5dc6d88292f9c32a5b7a2fecc64deaaeb12a0a1) Thanks [@vokhoadev](https://github.com/vokhoadev)! - Export `isContinueUpstreamMidToolCallError`, `MID_TOOL_CALL_CONTINUE_UPSTREAM_HINT`, `streamTailNeedsAgentRecovery`, and re-export `ContinueUpstreamMidToolCallError` / `tailBlocksContinueUpstream` for RFC 0018 recovery ergonomics.
...
- Updated dependencies [[`c5dc6d8`](https://github.com/ziroagent/sdk-typescript/commit/c5dc6d88292f9c32a5b7a2fecc64deaaeb12a0a1), [`c5dc6d8`](https://github.com/ziroagent/sdk-typescript/commit/c5dc6d88292f9c32a5b7a2fecc64deaaeb12a0a1), [`c5dc6d8`](https://github.com/ziroagent/sdk-typescript/commit/c5dc6d88292f9c32a5b7a2fecc64deaaeb12a0a1), [`c5dc6d8`](https://github.com/ziroagent/sdk-typescript/commit/c5dc6d88292f9c32a5b7a2fecc64deaaeb12a0a1)]:
  ...
  - @ziro-agent/tracing@0.11.0
  - @ziro-agent/memory@0.5.6
...
- Updated dependencies [[`63fda9b`](https://github.com/ziroagent/sdk-typescript/commit/63fda9bb245502510d0d92703594de826d438b1a), [`63fda9b`](https://github.com/ziroagent/sdk-typescript/commit/63fda9bb245502510d0d92703594de826d438b1a)]:
  ...
  - @ziro-agent/tracing@0.10.1
  - @ziro-agent/memory@0.5.5
...
- Updated dependencies [[`d1c6abd`](https://github.com/ziroagent/sdk-typescript/commit/d1c6abd6c29168fc5c54bddd21fcedf762539574)]:
  ...
  - @ziro-agent/memory@0.5.3
  - @ziro-agent/tools@0.6.7
  - @ziro-agent/tracing@0.9.4
...
- Updated dependencies [[`fb04cd2`](https://github.com/ziroagent/sdk-typescript/commit/fb04cd200af279907da0ee7e915b67ee485892d0)]:
  ...
  - @ziro-agent/memory@0.5.2
  - @ziro-agent/tools@0.6.6
  - @ziro-agent/tracing@0.9.3
...
- Updated dependencies [[`1d0f6cd`](https://github.com/ziroagent/sdk-typescript/commit/1d0f6cd685f8c09728414b0ad645e19c5676ce59)]:
  - @ziro-agent/memory@0.5.1

## 0.17.1

### Patch Changes

- Updated dependencies [[`8be0f1a`](https://github.com/ziroagent/sdk-typescript/commit/8be0f1a908ca4e93a0cec740a676bfaaa243ff9a)]:
  - @ziro-agent/memory@0.5.0
...
- Updated dependencies []:
  - @ziro-agent/memory@0.4.0
  - @ziro-agent/tracing@0.9.0
...
- Updated dependencies [[`1354315`](https://github.com/ziroagent/sdk-typescript/commit/1354315b2d2de6f13744a962039541301a1ffef6)]:
  ...
  - @ziro-agent/tracing@0.7.0
  - @ziro-agent/memory@0.2.6
...
- [#53](https://github.com/ziroagent/sdk-typescript/pull/53) [`ab6ab69`](https://github.com/ziroagent/sdk-typescript/commit/ab6ab693e1b1099b25e77fc36517c9f916a46de4) Thanks [@vokhoadev](https://github.com/vokhoadev)! - Add `prepareStep` hook on `createAgent`, `agent.run`, and `agent.resume` for per-iteration `model`, `system`, and `activeTools` overrides (RFC 0004).

### Patch Changes

- [#53](https://github.com/ziroagent/sdk-typescript/pull/53) [`ab6ab69`](https://github.com/ziroagent/sdk-typescript/commit/ab6ab693e1b1099b25e77fc36517c9f916a46de4) Thanks [@vokhoadev](https://github.com/vokhoadev)! - Add `agent.listCheckpoints(threadId, opts?)` — delegates to the agent's `Checkpointer.list` for UI / pagination without holding the checkpointer separately.
...
- Updated dependencies [[`ab6ab69`](https://github.com/ziroagent/sdk-typescript/commit/ab6ab693e1b1099b25e77fc36517c9f916a46de4), [`ab6ab69`](https://github.com/ziroagent/sdk-typescript/commit/ab6ab693e1b1099b25e77fc36517c9f916a46de4), [`ab6ab69`](https://github.com/ziroagent/sdk-typescript/commit/ab6ab693e1b1099b25e77fc36517c9f916a46de4), [`ab6ab69`](https://github.com/ziroagent/sdk-typescript/commit/ab6ab693e1b1099b25e77fc36517c9f916a46de4)]:
  ...
  - @ziro-agent/memory@0.2.5
  - @ziro-agent/tools@0.6.3
  - @ziro-agent/tracing@0.6.3
...
- [#45](https://github.com/ziroagent/sdk-typescript/pull/45) [`5e77412`](https://github.com/ziroagent/sdk-typescript/commit/5e77412a0d2e69c1a5d5960f529370e58bff4e14) Thanks [@vokhoadev](https://github.com/vokhoadev)! - Add `prepareStep` hook on `createAgent`, `agent.run`, and `agent.resume` for per-iteration `model`, `system`, and `activeTools` overrides (RFC 0004).
...
- Updated dependencies [[`5e77412`](https://github.com/ziroagent/sdk-typescript/commit/5e77412a0d2e69c1a5d5960f529370e58bff4e14), [`5e77412`](https://github.com/ziroagent/sdk-typescript/commit/5e77412a0d2e69c1a5d5960f529370e58bff4e14), [`5e77412`](https://github.com/ziroagent/sdk-typescript/commit/5e77412a0d2e69c1a5d5960f529370e58bff4e14), [`5e77412`](https://github.com/ziroagent/sdk-typescript/commit/5e77412a0d2e69c1a5d5960f529370e58bff4e14)]:
  ...
  - @ziro-agent/memory@0.2.3
  - @ziro-agent/tools@0.6.1
  - @ziro-agent/tracing@0.6.1
...
- Updated dependencies [[`8cbcd93`](https://github.com/ziroagent/sdk-typescript/commit/8cbcd93ca9a1797a14790d886dade9860990896d), [`8cbcd93`](https://github.com/ziroagent/sdk-typescript/commit/8cbcd93ca9a1797a14790d886dade9860990896d)]:
  ...
  - @ziro-agent/tracing@0.5.0
  - @ziro-agent/memory@0.2.1
...
- Updated dependencies [[`b2ce8c9`](https://github.com/ziroagent/sdk-typescript/commit/b2ce8c95e7333d5ac880bfd9f49e3f878f5eddab)]:
  - @ziro-agent/memory@0.2.0
  - @ziro-agent/tools@0.4.2
  - @ziro-agent/core@0.5.1
  - @ziro-agent/tracing@0.4.1
...
- Updated dependencies [[`16d80c8`](https://github.com/ziroagent/sdk-typescript/commit/16d80c8a829b7ccfec977058ab0f08a828cca468), [`bba9d98`](https://github.com/ziroagent/sdk-typescript/commit/bba9d9813d8375b7bfad3bef37d93531d14c4b2d), [`ec901c8`](https://github.com/ziroagent/sdk-typescript/commit/ec901c8554bc0f4e1577eeff8a5ab1b386c9097a)]:
  ...
  - @ziro-agent/tracing@0.4.0
  - @ziro-agent/tools@0.4.1

## 0.5.0

### Minor Changes

- 33e8de0: **New: multi-agent `handoffs[]` + `createNetwork()` (RFC 0007).**
...
- **`createAgent({ checkpointer, defaultThreadId })` + `agent.resumeFromCheckpoint(threadId, options)` (RFC 0006 §integration).**

  The `Checkpointer` interface — previously interface-only — is now wired into the agent runtime:

  - `createAgent({ checkpointer, defaultThreadId? })` accepts any `Checkpointer` implementation (`@ziro-agent/checkpoint-memory`, custom Redis/Postgres adapters, etc).
  - `run(...)` and `resume(...)` accept an optional per-call `threadId` that overrides `defaultThreadId`.
  - When BOTH a `checkpointer` and a `threadId` are configured, every `AgentSuspendedError` is auto-persisted via `checkpointer.put(threadId, snapshot)` BEFORE the error propagates to the caller — no manual storage glue required.
  - New `agent.resumeFromCheckpoint(threadId, { checkpointId?, decisions, ... })` convenience method wraps `checkpointer.get` + `agent.resume`.
  - Persistence failures are logged on `console.error` and never mask the original `AgentSuspendedError` — durability is best-effort.

  Auto-checkpointing inside the loop (per-message / per-invocation strategies) lands in v0.2 once `AgentSnapshot` captures non-suspended mid-run state.

  No breaking changes.

- cdfad7c: **Snapshot v2 — `parsedArgs` on `resolvedSiblings` + `migrateSnapshot()` helper**
