...
| H4  | Code interpreter sandbox (E2B / Modal)               | PARTIAL  | P0   | `@ziro-agent/sandbox-e2b`; Modal/Daytona GAP — RFC 0013 |
| H5  | Browser tool (Playwright / Browserbase)              | PARTIAL  | P0   | `@ziro-agent/browser-playwright`; Browserbase GAP — RFC 0013 |
